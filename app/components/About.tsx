...
export default function About() {
    return (
        <div className="text-white w-screen flex flex-col lg:flex-row lg:h-screen">
            <div className="lg:flex h-full items-center hidden justify-end w-full lg:w-2/6 bg-[#171717] lg:bg-[#292828] ">
                <img className="md:h-[650px] w-full p-6 lg:p-0 h-full object-cover -mr-56 pt-10 z-30" src="images/portfolioImage3.jpg" alt="" />
            </div>
            <div className="h-full lg:w-4/6 justify-center py-10 bg-[#171717] items-center lg:gap-10 flex flex-col">
                <div className="flex gap-8 pt-3 lg:pt-0">
                ...
                <div className="lg:w-[440px] p-5 lg:p-0 flex lg:text-xl text-xs flex-col gap-6">
                    <span className="">
